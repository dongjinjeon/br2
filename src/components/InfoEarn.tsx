      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            accumulated will be automatically transferred to their wallet ()
          </li>
          <li>
            4. Users can use Me app to convert secretSCRT (privacy token) to SCRT (Acent Network native coin) using
